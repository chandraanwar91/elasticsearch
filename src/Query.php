...
use Chandraanwar91\Elasticsearch\Classes\Bulk;
use Chandraanwar91\Elasticsearch\Classes\Search;
use Chandraanwar91\Elasticsearch\Collection;
...
class Query
{
     ...
     * @var \Chandraanwar91\Elasticsearch\Model
     */
    public $model;
