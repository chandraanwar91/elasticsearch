...
use Chandraanwar91\Elasticsearch\Commands\ReindexCommand;
use Elasticsearch\ClientBuilder as ElasticBuilder;
use Illuminate\Contracts\Container\BindingResolutionException;
use Illuminate\Support\ServiceProvider;
use Laravel\Scout\EngineManager;
use Chandraanwar91\Elasticsearch\Commands\ListIndicesCommand;
use Chandraanwar91\Elasticsearch\Commands\CreateIndexCommand;
use Chandraanwar91\Elasticsearch\Commands\DropIndexCommand;
use Chandraanwar91\Elasticsearch\Commands\UpdateIndexCommand;

/**
 * Class ElasticsearchServiceProvider
 * @package Chandraanwar91\Elasticsearch
 */
